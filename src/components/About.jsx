import user_image from "../assets/beatrice.jpeg";

import code_icon from "../assets/bj.jpg";
import code_icon_dark from "../assets/bj.jpg";
import edu_icon from "../assets/cyt.jpg";
import edu_icon_dark from "../assets/cyt.jpg";
      ...
      <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
        ...
        <div className="flex-1">
          <p className="mb-10 max-w-2xl font-Ovo">
            I am an experienced financial adviser with over 19 years of
            experience. My goal is to thoroughly understand your financial needs
            and then align the resources to help you meet or exceed them. I can
            help you evaluate near-term concerns and plan for long-term goals,
            be a sounding board for investment ideas, assist you in developing
            and executing a strategy that is precisely your own and helps you
            meet your needs..
          </p>
          ...
          <ul className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl">
            ...
            >
              ...
              <p className="text-gray-600 text-sm dark:text-white/80">
                An Expert in Business Development.
              </p>
            </li>
            <li className="border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 hover:shadow-black dark:border-white dark:hover:shadow-white dark:hover:bg-darkHover/50">
              ...
              <p className="text-gray-600 text-sm dark:text-white/80">
                An Expert in crypto Investment and crypto currency mining.
              </p>
            </li>
            <li className="border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 hover:shadow-black dark:border-white dark:hover:shadow-white dark:hover:bg-darkHover/50">
              ...
              <p className="text-gray-600 text-sm dark:text-white/80">
                A Consultant & Expert in Investment Banking.
              </p>
            </li>
          </ul>
